...
- :book: [A.out binary format](https://wiki.osdev.org/A.out) (October 2021)
...
- :book: [Common object file format](https://wiki.osdev.org/COFF) (January 2020)
- :book: [Executable and linkable format](https://wiki.osdev.org/ELF) (December 2021)
- :book: [Executable file formats](https://docs.fileformat.com/executable) (March 2022)
...
- :clipboard: [Microsoft portable executable and common object file format specification](http://www.skyfree.org/linux/references/coff.pdf) (February 1999)
- :book: [MZ disk operating system](https://wiki.osdev.org/MZ) (May 2021)
...
- :earth_americas: [PE format (Microsoft docs)](https://docs.microsoft.com/en-us/windows/win32/debug/pe-format) (November 2021)
...
- :book: [Portable executable](https://wiki.osdev.org/PE) (January 2022)
- :clipboard: [Win32 portable executable packing uncovered](https://securitylabs.websense.com/content/Assets/HistoryofPackingTechnology.pdf) (July 2009)
